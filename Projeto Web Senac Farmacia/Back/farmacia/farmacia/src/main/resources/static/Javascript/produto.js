...
function showEditModal(index) {
    ...
    // Preenche os selects de marca e categoria com os valores do produto
    editBrandSelect.value = product.marca.id;
    editCategorySelect.value = product.categoria.id;
...
const addProduct = async () => {
    ...
    if (newProduct.preco <= 0 ||newProduct.quantidade < 0) {
        alert('Por favor, digite os numeros corretamente!')
        return
    }
